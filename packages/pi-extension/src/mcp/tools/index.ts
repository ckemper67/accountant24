...
/** Writer tools -- each runs its whole cycle inside `writerMutex`. */
export const WRITER_SPECS: McpToolSpec[] = [addTransactionsSpec, addBalanceAssertionsSpec, addPricesSpec, bulkEditSpec];
